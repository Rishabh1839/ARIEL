...
def userDataImport():
    ...
    print("")
    csvData1 = input(" Filepath1: ")
    csvData2 = input("Filepath2: ")

    with open(csvData1, 'r') as importData1:
      userData1 = csv.reader(importData1)

    with open(csvData2, 'r') as importData2:
      userData2 = csv.reader(importData2)
